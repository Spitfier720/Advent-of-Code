...
while(line):
    ...
    for x in range(width):
        #Finding all the lowest elevation spots("a") that we will add to the list of starting coordinates.
        if(line[x] == "a"):
            start.append((height, x))
        ...
        #"S" is still added to the list as is, since it won't affect our pathfinding due to its ascii value.
        else:
            row.append(line[x])
